...
SELECT * FROM HASHTAG_JOB; SELECT * FROM HASHTAG_MEETUP;
...
COMMENT ON COLUMN "WORKMAN"."BOARD_JOB"."CONTENT" IS '글내용';
COMMENT ON COLUMN "WORKMAN"."BOARD_JOB"."REGDATE" IS '작성일';
COMMENT ON COLUMN "WORKMAN"."BOARD_JOB"."COUNT" IS '조회수';
COMMENT ON COLUMN "WORKMAN"."BOARD_JOB"."STATUS" IS '게시글 상태(1, 0, -1)';
